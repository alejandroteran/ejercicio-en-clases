...
void main()
{
    ...
    if (edad>=0 && edad<=1 && nivelHem>=13 && nivelHem<=26)
        printf("No tiene anemia");
            ...
            printf("No tiene anemia");
    else if (edad>12 && edad<=60 && nivelHem>=11.5 && nivelHem<=15)
            printf("No tiene anemia");
    else if (edad>60 && edad<=120 && nivelHem>=12.6 && nivelHem<=15.5)
            printf("No tiene anemia");
    else if (edad>120 && edad<=180 && nivelHem>=13 && nivelHem<=15.5)
            printf("No tiene anemia");
    else
            printf("Tiene anemia");
}